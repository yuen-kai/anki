...
fun isSvelteKitPage(path: String): Boolean {
    ...
    return when (pageName) {
        ...
        "import-page",
        "image-occlusion",
        // The Speedrun SvelteKit shell is the app's primary UI, served as SPA
        // routes. All cross-screen navigation is client-side, so the whole shell
        // runs in one WebView starting at speedrun-decks.
        "speedrun-decks",
        "speedrun-study",
        "speedrun-hierarchy",
        "speedrun-review",
