...
import com.ichi2.anki.pages.SpeedrunReviewFragment
...
open class DeckPicker :
    ...
    private fun handleContextMenuSelection(
        ...
        when (selectedOption) {
            ...
            DeckPickerContextMenuOption.SPEEDRUN_STUDY -> {
                Timber.i("ContextMenu: Speedrun study selected")
                startActivity(SpeedrunReviewFragment.getIntent(this, deckId))
                dismissAllDialogFragments()
            }
